                ...
                <div className="row">
                    ...
                    <div className="col-sm-12 col-md-12">
                        ...
                        <div className="col-md-12">
                            ...
                            <div className='row'>
                                <div className="col-md-3 div-transactions">
                                    <label>Filter by name</label>
                                    <br></br>
                                    <input className="form-control" name="filterName" value={this.state.filterName} onChange={this.handleFilterChange}></input>
                                </div>
                                <div className="col-md-3 div-transactions">
                                    <label>Filter by category</label>
                                    <br></br>
                                    <select className="form-control" name="filterCategory" value={this.state.filterCategory} onChange={this.handleFilterChange}>
